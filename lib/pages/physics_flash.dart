...
class PhysicsFlash extends StatefulWidget {
  @override
  _PhysicsFlashState createState() => _PhysicsFlashState();
}

class _PhysicsFlashState extends State<PhysicsFlash> {
  ...
  Future<void> _loadFacts() async {
    final contents = await rootBundle.loadString('assets/phyflash.txt');
