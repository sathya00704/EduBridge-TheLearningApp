...
class BiologyFlashTamil extends StatefulWidget {
  @override
  _BiologyFlashTamilState createState() => _BiologyFlashTamilState();
}

class _BiologyFlashTamilState extends State<BiologyFlashTamil> {
  ...
  Future<void> _loadFacts() async {
    final contents = await rootBundle.loadString('assets/bioflashtamil.txt');
