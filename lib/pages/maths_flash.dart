...
class MathsFlash extends StatefulWidget {
  @override
  _MathsFlashState createState() => _MathsFlashState();
}

class _MathsFlashState extends State<MathsFlash> {
  ...
  Future<void> _loadFacts() async {
    final contents = await rootBundle.loadString('assets/mathsflash.txt');
