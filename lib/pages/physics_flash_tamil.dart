...
class PhysicsFlashTamil extends StatefulWidget {
  @override
  _PhysicsFlashTamilState createState() => _PhysicsFlashTamilState();
}

class _PhysicsFlashTamilState extends State<PhysicsFlashTamil> {
  ...
  Future<void> _loadFacts() async {
    final contents = await rootBundle.loadString('assets/phyflashtamil.txt');
